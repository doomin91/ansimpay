...
<body>
                ...
                <div id="nav-section">
                    <div class="bottom-header container-fluid mega-menus" id="mega-menus">
                        <nav class="navbar navbar-toggleable-md no-border-radius no-margin mega-menu-multiple" id="navbar-inner-container">
                            ...
                            <a class="navbar-brand mr-auto m-sm-auto" href="index.html"> <img src="assets/img/logo.svg" alt="roxine"> <img src="assets/img/logo-dark.svg" alt="roxine"> </a>
                                                ...
                                                <ul class="s-list no-padding">
                                                    <li class="row">
                                                        <div class="col-lg-4 col-md-4 col-sm-5 col">
                                                            <div class="img">
                                                                <a href="#"><img src="assets/img/img-02.jpg" alt="image description"></a>
                                                            </div>
                                                        </div>
            ...
            <main>
                    ...
                    <div class="visual-inner blog-default-banner dark-overlay parallax" data-stellar-background-ratio="0.55">
                        <div class="container">
                            <div class="visual-text-large text-left visual-center">
                                <h1 class="visual-title visual-sub-title">The Default Blog</h1>
                ...
                <div class="content-wrapper">
                    <section class="content-block">
                        <div class="container">
                            <div id="news_more_btn " class="row multiple-row">
                                <div class="col-md-6">
                                    <div class="col-wrap">
                                        <div class="post-grid reverse-grid reverse-grid">
                                            <div class="img-block post-img">
                                                <a href="#"><img src="assets/img/img-30.jpg" alt="images"></a>
                                ...
                                <div class="col-md-6">
                                    <div class="col-wrap">
                                        <div class="post-grid reverse-grid">
                                            <div class="img-block post-img">
                                                <a href="#"><img src="assets/img/img-31.jpg" alt="images"></a>
                                                <time class="post-date" datetime="2016-10-10">17 Jun</time>
                                            </div>
                                            <div class="post-text-block bg-gray-light">
                                ...
                                <div class="col-md-6">
                                    <div class="col-wrap">
                                        <div class="post-grid reverse-grid">
                                            <div class="img-block post-img">
                                                <a href="#"><img src="assets/img/img-32.jpg" alt="images"></a>
                                                <time class="post-date" datetime="2016-10-10">17 Jun</time>
                                            </div>
                                            <div class="post-text-block bg-gray-light">
                                ...
                                <div class="col-md-6">
                                    <div class="col-wrap">
                                        <div class="post-grid reverse-grid">
                                            <div class="img-block post-img">
                                                <a href="#"><img src="assets/img/img-33.jpg" alt="images"></a>
                                                <time class="post-date" datetime="2016-10-10">17 Jun</time>
                                            </div>
                                            <div class="post-text-block bg-gray-light">
                                ...
                                <div class="col-md-6">
                                    <div class="col-wrap">
                                        <div class="post-grid reverse-grid">
                                            <div class="img-block post-img">
                                                <a href="#"><img src="assets/img/img-34.jpg" alt="images"></a>
                                                <time class="post-date" datetime="2016-10-10">17 Jun</time>
                                            </div>
                                            <div class="post-text-block bg-gray-light">
                                ...
                                <div class="col-md-6">
                                    <div class="col-wrap">
                                        <div class="post-grid reverse-grid">
                                            <div class="img-block post-img">
                                                <a href="#"><img src="assets/img/img-35.jpg" alt="images"></a>
                                                <time class="post-date" datetime="2016-10-10">17 Jun</time>
                                            </div>
                                            <div class="post-text-block bg-gray-light">
                                                <strong class="content-title mb-0"><a href="#">Heading South</a></strong>
                                ...
                                <div class="col-md-6">
                                        <div class="col-wrap">
                                            <div class="post-grid reverse-grid">
                                                <div class="img-block post-img">
                                                    <a href="#"><img src="assets/img/img-36.jpg" alt="images"></a>
                                                    <time class="post-date" datetime="2016-10-10">17 Jun</time>
                                                </div>
                                                <div class="post-text-block bg-gray-light">
                                                    <strong class="content-title mb-0"><a href="#">Working Remotely</a></strong>
                                ...
                                <div class="col-md-6">
                                        <div class="col-wrap">
                                            <div class="post-grid reverse-grid">
                                                <div class="img-block post-img">
                                                    <a href="#"><img src="assets/img/img-37.jpg" alt="images"></a>
                                                    <time class="post-date" datetime="2016-10-10">17 Jun</time>
                                                </div>
                                                <div class="post-text-block bg-gray-light">
                                                    <strong class="content-title mb-0"><a href="#">Leaving With A Note</a></strong>
                            ...
                            <div id="news_more_btn_tab" class="btn-container full-width-btn top-space">
                                <a href="javascript:news_more_btn()" class="btn btn-black">LOAD MORE<span class="c-ripple js-ripple"><span class="c-ripple__circle"></span></span></a>
                            </div>
                        </div>
                    </section>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="footer-logo mt-2">
                                <img src="assets/img/logo.svg" alt="image-description">
                            </div>
                        </div>
                        <div class="col-lg-4">
    ...
    <script>
        var bnews_more_btn = true;
        function news_more_btn(){
            var con = document.getElementById("hide");
            if(con.style.display=='none'){
                con.style.display = 'block';
                con.appendTo("<div id='news_more_btn_tab' class='btn-container full-width-btn top-space'><a href='javascript:news_more_btn()' class='btn btn-black'>LOAD MORE<span class='c-ripple js-ripple'><span class='c-ripple__circle'></span></span></a></div>")
            }else{
