                ...
                <div id="nav-section">
                    ...
                    <div class="bottom-header container mega-menus" id="mega-menus">
                        <nav class="navbar navbar-toggleable-md no-border-radius no-margin mega-menu-multiple" id="navbar-inner-container">
                            ...
                            <a class="navbar-brand mr-auto m-sm-auto" href="index.html"> <img src="assets/img/logo.svg" alt="roxine"> </a>
                            ...
                            <div class="row multiple-row v-align-row">
                                    ...
                                    <div class="col-wrap">
                                        <div class="post-grid">
                                            <div class="img-block post-img">
                                                <img src="assets/img/img-26.jpg" alt="images">
                                            </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="col-wrap">
                                        <div class="post-grid">
                                            <div class="img-block post-img">
                                                <img src="assets/img/img-27.jpg" alt="images">
                                            </div>
                                            <div class="post-text-block bg-gray-light">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="col-wrap">
                                        <div class="post-grid">
                                            <div class="img-block post-img">
                                                <img src="assets/img/img-28.jpg" alt="images">
                                            </div>
                                            <div class="post-text-block bg-gray-light">
                            ...
                            <div class="logo-list text-center">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-xl-3">
                                        <div class="top-xl-space">
                                            <div class="img-wrap">
                                                <img src="assets/img/logo-02.webp" alt="logo">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-xl-3">
                                        <div class="top-xl-space">
                                            <div class="img-wrap">
                                                <img src="assets/img/logo-03.webp" alt="logo">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-xl-3">
                                        <div class="top-xl-space">
                                            <div class="img-wrap">
                                                <img src="assets/img/logo-04.webp" alt="logo">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-xl-3">
                                        <div class="top-xl-space">
                                            <div class="img-wrap">
                                                <img src="assets/img/logo-05.webp" alt="logo">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-xl-3">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="info-block info-block-v2 block-1 col-sm-6 col-lg-3 text-center">
                                    <div class="icon">
                                        <img src="assets/img/icons/icon-planning.webp" alt="planning">
                                    </div>
                                ...
                                <div class="info-block info-block-v2 block-2 col-sm-6 col-lg-3 text-center">
                                    <div class="icon">
                                        <img src="assets/img/icons/icon-design.webp" alt="design">
                                    </div>
                                ...
                                <div class="info-block info-block-v2 block-3 col-sm-6 col-lg-3 text-center">
                                    <div class="icon">
                                        <img src="assets/img/icons/icon-service.webp" alt="design">
                                    </div>
                                ...
                                <div class="info-block info-block-v2 block-4 col-sm-6 col-lg-3 text-center">
                                    <div class="icon">
                                        <img src="assets/img/icons/icon-support.webp" alt="design">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="team-box caption-fade-up">
                                        <div class="img-block">
                                            <img src="assets/img/team-06.jpg" alt="images description">
                                        </div>
                                        <figure>
                                ...
                                <div class="col-md-4">
                                    <div class="team-box caption-fade-up">
                                        <div class="img-block">
                                            <img src="assets/img/team-05.jpg" alt="images description">
                                        </div>
                                        <figure>
                                            <figcaption class="team-des-v2">
                                ...
                                <div class="col-md-4">
                                    <div class="team-box caption-fade-up">
                                        <div class="img-block">
                                            <img src="assets/img/team-04.jpg" alt="images description">
                                        </div>
                                        <figure>
                                            <figcaption class="team-des-v2">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="footer-logo">
                                <img src="assets/img/logo-dark.svg" alt="image-description">
                            </div>
                        </div>
                        <div class="col-md-5">
