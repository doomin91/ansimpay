    ...
    <div id="wrapper">
                ...
                <div id="nav-section">
                    <div class="bottom-header container-fluid mega-menus" id="mega-menus">
                        <nav class="navbar navbar-toggleable-md no-border-radius no-margin mega-menu-multiple" id="navbar-inner-container">
                            ...
                            <a class="navbar-brand mr-auto m-sm-auto" href="index.html"> <img src="assets/img/logo-dark.svg" alt="roxine"> </a>
                            ...
                            <div class="logo-container">
                                <div class="owl-carousel logo-slide" id="waituk-owl-slide-4">
                                    <div class="slide-item">
                                        <img src="assets/img/logo-01.webp" alt="images description">
                                    </div>
                                    <div class="slide-item">
                                        <img src="assets/img/logo-02.webp" alt="images description">
                                    </div>
                                    <div class="slide-item">
                                        <img src="assets/img/logo-03.webp" alt="images description">
                                    </div>
                                    <div class="slide-item">
                                        <img src="assets/img/logo-04.webp" alt="images description">
                                    </div>
                                    <div class="slide-item">
                                        <img src="assets/img/logo-03.webp" alt="images description">
                                    </div>
        ...
        <footer class="footer">
            <div class="content-block footer-main text-center">
                <div class="container">
                    <div class="waituk_newsletter-form">
                        <form  action="#" id="signup" method="post">
                            <fieldset class="clearfix">
                                ...
                                <input type="submit" class="btn btn-trans-dark-gray" value="Subscribe">
                            </fieldset>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="holder">
                                    ...
                                    <p> Call Us On</p>
                                    <p><a class="footer-link" href="tel:9779851108896">977 985 1108896</a></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="holder">
                                    ...
                                    <p> Email Us At</p>
                                    <p>Email at <a href="mailto:waituk.net">Waituk.net</a></p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="holder">
